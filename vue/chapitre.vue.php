                    ...
                    foreach ($comments as $comment) : ?>
                        <article class="post">
                            ...
                            <p class="text-right">Publié
                                le <?= date("d-m-Y à H:i", strtotime($comment->getCreatedAt())); ?></p>
                            <p>
                                <?php if ($comment->isReported() == true) :
                    ...
                    <form action='/chapitre?id=<?= $post->getId(); ?>' method="post">
                        ...
                        <div class="form-group ">
                            ...
                            <input class="form-control
                                <?php if (isset($erreursForm['author'])) :
                                echo ' erreur-form';
                            endif; ?>"
                        ...
                        <div class="form-group ">
                            ...
                            <?php if (isset($erreursForm['comment'])) :
                                echo ' erreur-form';
                            endif; ?>"
